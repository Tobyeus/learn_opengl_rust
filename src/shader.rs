...
impl Shader {
    ...
    pub fn set_vector3(&self, name: &str, v_x: f32, v_y: f32, v_z: f32) {
        unsafe { gl::Uniform3f(gl::GetUniformLocation(self.program, CString::new(name).unwrap().as_ptr()), v_x, v_y, v_z); }
    }
